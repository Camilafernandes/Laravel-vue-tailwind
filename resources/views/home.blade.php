            ...
            <form id="app" @submit.prevent="getFormValues" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-6" v-if="visible >= 18">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none 
                        focus:shadow-outline" id="driver_license" type="text">
                ...
                <div class="mb-6">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="state" type="text">
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2">
                        Cidade
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="city" type="text">
                </div>
                <div class="mb-6" v-show="phones_1">
                    <label class="block text-gray-700 text-sm font-bold mb-2">
                        Telefones
                    </label>
                    <input class="shadow appearance-none border rounded w-1/12 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="ddd" type="text">
                     <input class="shadow appearance-none border rounded w-6/12 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="phone" type="text">
                ...
                <div class="mb-6" v-show="emails_1">
                    ...
                    <input class="shadow appearance-none border rounded w-9/12 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="emails" type="email">
                    <label class="bg-transparent hover:text-red-500 text-red-700  w-2/12  font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-10"
                ...
                <div class="mb-6" v-if="visible < 18 && visible != null">
                    <label class="block text-gray-700 text-sm font-bold mb-2" >
                        Responsável
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-5" 
                        id="parent_name" name="parent_name" type="text" placeholder="Nome Responsável">
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" 
                        id="parent_phone" type="text" placeholder="Telefone Responsável">
                </div>
